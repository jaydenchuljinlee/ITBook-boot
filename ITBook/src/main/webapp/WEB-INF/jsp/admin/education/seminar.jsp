	...
	<div class="col-md-12">
		<div class="widget wred">
			<div class="widget-head">
			  <div class="pull-left">세미나 목록</div>
			  <div class="clearfix"></div>
			</div>
				...
				<div class="table-responsive">
					<table class="table table-bordered ">
						...
						<tbody>
							<tr>
							  	<td>10</td>
							  	<td class="seminarDetail"><a href="#">[32차] 대한민국 개발자의 생존전략 2.17</a></td>
							  	<th>한큐</th>
							  	<td>2018-03-13</td>
							  	<td>09:00 ~ 13:00</td>
							...
							<tr>
							  	<td>9</td>
							  	<td class="seminarDetail"><a href="#">김왼손의 미운코딩새끼:4시간만에 끝내는 파이썬 기초</a></td>
							  	<th>김왼손</th>
							  	<td>2018-03-11</td>
							  	<td>14:00 ~ 18:00</td>
			...
			<div class="widget-foot">
				<ul class="pagination pull-left">
				  <li id="addSeminarBtn"><a href="#">새 세미나 등록</a></li>
				</ul>
...
$(function() {
	$(".seminarDetail").click(function() {
		location.href = "adminSeminarDetail.do";
	});
	
	$("#addSeminarBtn").click(function() {
		location.href = "adminSeminarInsertForm.do";
	});
});
</script>
