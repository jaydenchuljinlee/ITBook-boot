...
<form id="bookMoveFrm" action="bookDetail">
...
<div class="parallax-window inner-banner tc-padding overlay-dark"
	...
	<div class="container">
		<div class="inner-page-heading style-2 h-white">
			<h2 style="font-size: 30px; color: #2c2255">신간 도서</h2>
			<p style="font-size: 20px; color: #2c2255">새로운 도서들을 만나보세요.</p>
		</div>
	</div>
</div>
<!-- Inner Banner -->
		...
		<!-- Filter Sort -->
				...
				<div class="row">
					<c:forEach items="${bookList}" var="book">
						<div id=<c:out value='${book.isbn}'/> class="col-lg-3 col-xs-6 r-full-width book-list">
							<div class="product-box">
								...
								<div class="product-detail">
									<span><c:out value='${book.author}'/> (지은이)</span> 
									<span><c:out value='${book.publish}'/> | <c:out value='${book.publishdate}'/></span>
									<h5 class="ellipsis"><c:out value='${book.theme}'/></h5>
									<p class="ellipsis">
